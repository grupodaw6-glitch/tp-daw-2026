...
exports.TemplatePlaygroundComponent = void 0;
...
let TemplatePlaygroundComponent = class TemplatePlaygroundComponent {
    http;
    editorService;
    zipService;
    hbsService;
    ...
    constructor(http, editorService, zipService, hbsService) {
        this.http = http;
    ...
    initializeEditor() {
        ...
        this.editorService.setOnChangeCallback((content) => {
            this.scheduleAutoSave(content);
        });
    }
    async selectFile(template) {
...
exports.TemplatePlaygroundComponent = TemplatePlaygroundComponent;
__decorate([
    (0, core_1.ViewChild)('editorContainer', { static: true }),
    __metadata("design:type", typeof (_b = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" ? _b : Object)
], TemplatePlaygroundComponent.prototype, "editorContainer", void 0);
__decorate([
    (0, core_1.ViewChild)('previewFrame', { static: true }),
    __metadata("design:type", typeof (_c = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" ? _c : Object)
], TemplatePlaygroundComponent.prototype, "previewFrame", void 0);
exports.TemplatePlaygroundComponent = TemplatePlaygroundComponent = __decorate([
    (0, core_1.Component)({
  ...
  `]
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof http_1.HttpClient !== "undefined" && http_1.HttpClient) === "function" ? _a : Object, template_editor_service_1.TemplateEditorService,
        zip_export_service_1.ZipExportService,
        hbs_render_service_1.HbsRenderService])
], TemplatePlaygroundComponent);
//# sourceMappingURL=template-playground.component.js.map